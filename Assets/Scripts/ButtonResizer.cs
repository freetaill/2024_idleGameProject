...
public class ButtonWidthScaler : MonoBehaviour
{
    ...
    public float normalWidth = 180f;   // 일반 버튼의 너비
    public float shrinkedWidth = 144f; // 축소된 버튼의 너비
    ...
    private void OnButtonClick(Button clickedButton)
    {
        ...
        {
            // 모든 버튼의 너비를 축소된 크기로 변경
            ShrinkAllButtonWidths();
    ...
    private void ShrinkAllButtonWidths()
    {
        foreach (Button button in buttons)
        {
            SetButtonWidth(button, shrinkedWidth);
        }
    }
